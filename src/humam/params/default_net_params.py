...
params["cytoarchitecture_params"] = {
    ...
    "src_path": os.path.join(
        os.getcwd(), "experimental_data", "voneconomokoskinas", "StructuralData_VonEconomoKoskinas_addedvalues.xls"
    ),
...
params["predictive_connectomic_params"] = {
    ...
    "con_path": os.path.join(
        os.getcwd(), "experimental_data", "hcp_dti", "Connectivity_Distances_HCP_DesikanKilliany.mat"
    ),
    "vol_path": os.path.join(os.getcwd(), "experimental_data", "hcp_dti", "DKAtlas_VolumeAndNames.mat"),
