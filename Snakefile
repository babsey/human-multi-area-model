...
rule createNetwork:
    ...
    shell:
        '{RUN_CREATE} snakemake/snakemake_network.py {input} {output}'
...
rule simulateNetwork:
    ...
    shell:
        '{RUN_SIMULATE} snakemake/snakemake_simulation.py {input} {output} {THREADS_SIMULATE}'
...
rule analyzeNetwork:
    ...
    shell:
        '{RUN_ANALYSIS} snakemake/snakemake_analysis.py {input} {output} {BASE_PATH}'
