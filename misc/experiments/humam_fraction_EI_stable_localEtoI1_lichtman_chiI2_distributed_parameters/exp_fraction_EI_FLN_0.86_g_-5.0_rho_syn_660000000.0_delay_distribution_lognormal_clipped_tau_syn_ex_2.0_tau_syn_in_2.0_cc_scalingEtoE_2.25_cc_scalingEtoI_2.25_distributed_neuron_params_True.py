...
net_params = {
    "predictive_connectomic_params": {"FLN": 0.86, "rho_syn": 660000000.0},
    "cytoarchitecture_params": {
        # Path to ei ratio data
        "ei_ratio_path": os.path.join(os.getcwd(), "experimental_data", "fraction_EI", "lichtman.csv"),
    ...
    "delay_params": {"distribution": "lognormal_clipped"},
    "scaling_factors_recurrent": {
        ...
        "cc_scalingEtoI": 2.0 * 2.25,
    },
    "scaling_factors_external": {"scaling5E": 1.05, "scaling6E": 1.15},
    "neuron_params_E": {
...
ana_params = {
    "plotRasterArea": {"fraction": 0.05, "low": 2500, "high": 12500},
    "functconn_corr": {"exclude_diagonal": False},
}
