...
filepath = os.path.join(
    os.getcwd(),
    "out/8c49a09f51f44fbb036531ce0719b5ba/4772f0b020c9f3310f4096a6db758343/7f5b8ecbfce8346314b050b58bbab1cf/",
)
...
def create_hierarchy(cc_matrix, areas):
    ...
    """
    res = minimize(hier_dev, np.random.rand(cc_matrix[0].size), args=(cc_matrix,))
    hierarchy = res["x"]
...
for area in area_list:
    hierarchy_to_area_list.append(np.where(hierarchical_areas == area)[0][0])
